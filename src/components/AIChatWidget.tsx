...
export default function AIChatWidget({ token, embedded }: AIChatWidgetProps) {
  ...
  const panel = (
    <div className={`flex flex-col overflow-hidden ${embedded ? 'w-full h-[480px]' : 'fixed bottom-24 left-6 z-50 w-[380px] max-w-[calc(100vw-48px)] h-[520px] max-h-[calc(100vh-150px)] bg-[#0a0e1a]/95 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl'}`}>
      {/* Header */}
