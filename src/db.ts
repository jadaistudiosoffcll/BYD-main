...
export async function getDb() {
  ...
  const tables = [
    ...
    `CREATE TABLE IF NOT EXISTS tracking_urgent_updates (id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER NOT NULL, message TEXT NOT NULL, created_at TEXT DEFAULT CURRENT_TIMESTAMP)`,
